...
from rating.models import VOTE_CHOICES

# Create your views here.


@login_required
def vote(request, content_type, object_id, vote=0, can_vote_test=None, redirect_url=None,
         template_name=None, template_loader=loader, extra_context=None, context_processors=None,
         mimetype=None):
