...
from rating.models import Vote, VOTE_CHOICES

register = template.Library()


@register.inclusion_tag('rating/inline.html', takes_context=True)
def rating_for_object(context, object):
    ...
    data['object'] = object
    data['ct'] = '%s.%s' % (ContentType.objects.get_for_model(
        object).app_label, object.__class__.__name__.lower())

    return data


@register.inclusion_tag('rating/topflop.html', takes_context=True)
