...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='song',
            name='artist',
            field=models.ManyToManyField(blank=True, related_name='song_artist', through='song.SongArtists', to='artist.Artist'),
        ),
        migrations.AddField(
            model_name='song',
            name='creator',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='song_creator', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='song',
            name='genres',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='song_genre', to='song.Genre'),
        ),
        migrations.AddField(
            model_name='song',
            name='last_editor',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='song_last_editor', to=settings.AUTH_USER_MODEL),
        ),
    ]
